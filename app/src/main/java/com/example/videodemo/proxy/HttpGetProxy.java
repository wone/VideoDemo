...
import com.example.videodemo.proxy.HttpParser.ProxyRequest;
...
public class HttpGetProxy {
    final static public String TAG = "VideoDemo.HttpGetProxy";
    /**
     * 链接带的端口
     */
                    ...
                    if (hasResponseHeader) {
                        ...
                        if (httpResponse.size() > 0) {
                            ...
                            if (enableSendHeader) {
                                ...
                                Log.e(TAG, "send http header<----"+responseStr);
                            }
    ...
    private int sendPrebufferToMP(String fileName) throws IOException {
        ...
        Log.e(TAG, "sendPrebufferToMP:读取完毕...下载:" + download.getDownloadedSize() + ",读取:" + fileBufferSize);
