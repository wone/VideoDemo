...
public class ShortVideoPlayActivity extends Activity implements OnClickListener, OnCompletionListener, OnErrorListener, SurfaceHolder.Callback {
	...
	final Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
			case MSG_TYPE_SAVE_FAILURE:
//				Toast.makeText(ShortVideoPlayActivity.this, R.string.shortvideo_file_save_failure, Toast.LENGTH_SHORT).show();
				break;
			case MSG_TYPE_SAVE_SUCCESS:
//				
//				String prefix = ShortVideoPlayActivity.this.getString(R.string.shortvideo_file_save_success);
//				String path = (String) msg.obj;
//				Toast.makeText(ShortVideoPlayActivity.this, prefix + path, Toast.LENGTH_SHORT).show();
				
				//保存完后通知系统广播,方便图库及时更新
//				ImageUtil.savePhotoToSysAlbum(ShortVideoPlayActivity.this, path);
				break;
			case MSG_TYPE_SAVE_EXITS:
//				Toast.makeText(ShortVideoPlayActivity.this, R.string.shortvideo_file_save_exits, Toast.LENGTH_SHORT).show();
				break;
			}
		}
	};
...
//		if (Log.isColorLevel()) {
			Log.e(TAG,  "mMediaPlayer onError what=" + what + ",extra=" + extra);
//		}
...
//			}
			...
			mMediaPlayer.setOnPreparedListener(new OnPreparedListener(){
				...
				public void onPrepared(MediaPlayer mp) {
                    ...
                    Log.d(TAG,  "mMediaPlayer onPrepared: mDuration=" + mDuration);
...
//		Dialog dialog = DialogUtil.createCustomDialog(this,
//				DialogUtil.SUCCESS_DIALOG, null,
//				getString(R.string.shortvideo_play_error),
...
//		dialog.show();
//		
//		if (!mPlayFailReported) {
//			//如果播放失败上报相关信息
//			int avaialbeMem = (int) (DeviceInfoUtil.getSystemAvaialbeMemory() / 1024);
//			int fileSize = (int) (new File(mVideoPath).length() / 1024);
//			String deviceInfo = DeviceInfoUtil.getDeviceModel();
////			ReportController.reportClickEvent(app, "CliOper", "", "", "0X8004674", "0X8004674", 0, 0, "" + avaialbeMem, "" + fileSize, deviceInfo, mMd5);
//			
//			mPlayFailReported = true;
//		}
