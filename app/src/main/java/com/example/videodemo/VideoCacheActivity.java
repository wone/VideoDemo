...
public class VideoCacheActivity extends Activity {
    ...
    public static final String TAG = "VideoDemo.VideoCacheActivity";
    ...
    private static final int READY_BUFF = 200 * 1024;//2k kb
    private static final int CACHE_BUFF = 100 * 1024; //5bkb
    ...
    private void init() {
        ...
        this.remoteUrl = "http://www.androidbegin.com/tutorial/AndroidCommercial.3gp";

        this.localUrl = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separatorChar
                + "VideoDemoCache" + File.separatorChar + System.currentTimeMillis() + ".3gp";
        ...
        mVideoView.setOnErrorListener(new MediaPlayer.OnErrorListener() {
            ...
            public boolean onError(MediaPlayer mediaplayer, int what, int extra) {
                ...
                Log.d(TAG, "MediaPlayer onError: what=" + what + ", extra = " + extra + ", errorCnt = " + errorCnt);
                return true;
            }
        });
    }
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                if (progressDialog == null) {
                    progressDialog = ProgressDialog.show(VideoCacheActivity.this,
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Log.d(TAG, "url: " + remoteUrl + " +/n localUrl: " + localUrl);
